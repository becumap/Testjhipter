...
public class TestjhipterApp {

    private static final Logger log = LoggerFactory.getLogger(TestjhipterApp.class);

    private final Environment env;

    public TestjhipterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes Testjhipter.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TestjhipterApp.class);
